...
- [X] [ABC: Always Be Coding](https://medium.com/always-be-coding/abc-always-be-coding-d5f8051afce2#.4heg8zvm4) (Practice real challenges)
- [X] [Whiteboarding](https://medium.com/@dpup/whiteboarding-4df873dbba2e#.hf6jn45g1) (do whiteboarding before coding something)
- [X] [Demystifying Tech Recruiting](https://www.youtube.com/watch?v=N233T0epWTs) (Talk about recruitment process)
- [X] How to Get a Job at the Big 4:
    - [X] [How to Get a Job at the Big 4 - Amazon, Facebook, Google & Microsoft (video)](https://www.youtube.com/watch?v=YJZCUhxNCv8) (Talk about how to apply and prepare in big 4, Practive mock interview with friends, Practice on coding sites, Use whiteboard before solving any coding problems, Use Interview prep books and careercup.com like sites to prepare for interview related questions.)
